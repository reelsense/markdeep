...
! function() {
    ...
    function o(e) {
        function t() {
            l = e.indexOf("\n", s) + 1, u = u || /\S/.test(e.ss(s, s + a)), d = d || /\S/.test(e.ss(s + o + 1, l))
        }
        for (var r = {
            g: e,
            h: "",
            ...
            var i, s = S(0, e.lastIndexOf("\n", n)) + 1,
                a = n - s;
            for (i = n + M.length; e[i] === C; ++i);
            var o = i - s - 1,
                c = {
                    g: e.ss(0, s),
                    h: "",
            ...
            t();
            for (var h = !0, p = i; h;) {
                if (s = l, t(), 0 === s) return r;
                if (u ? c.j = "right" : d && (c.j = "left"), e[s + a] === C && e[s + o] === C) {
                    for (var f = a; o > f && e[s + f] === C; ++f);
                    var b = s + a,
                        g = s + o;
                    if (c.m += e.ss(p, b).rp(/^[ \t]*[ \t]/, " ").rp(/[ \t][ \t]*$/, " "), f === o) return c.m += e.ss(s + o + 1), c;
                    c.h += e.ss(b + 1, g) + "\n", p = g + 1
                } else h = !1
            }
        }
    ...
    function c(e, t, r, n) {
        var i = "[^ \\t\n" + t.source + "]",
            s = "(" + t.source + ")(" + i + "(?:.*?" + i + ")?)(" + t.source + ")(?![A-Za-z0-9])";
        return e.rp(RegExp(s, "g"), "<" + r + (n ? ' class="' + n + '"' : "") + ">$2</" + r + ">")
    }
    ...
    function l(e, t, r) {
        for (var n = r || /<pre(\s.*?)?>|<code(\s.*?)?>|<svg(\s.*?)?>|<script\s.*?>|<style\s.*?>|<protect>/i, i = ""; e.length > 0;) {
            ...
            if (-1 === s) i += t(e), e = "";
                ...
                i += t(e.ss(0, s));
                var a = S(e.ss(s + 1, s + 15).search(/[\s>]/), 0),
                    o = e.ss(s + 1, s + a + 1),
                    c = RegExp("</" + o + ">", "i"),
                    l = e.search(c); - 1 === l ? l = e.length : l += o.length + 3, i += e.ss(s, l), e = e.ss(l)
            }
        }
        return i
    }
    ...
    function u(t) {
        ...
        return t = t.rp(s, function(t) {
            var n = t.split("\n"),
                ...
                s = "" === n[0] ? 1 : 0,
                a = [];
            r(n[s + 1]).rp(/:?-+:?/g, function(e) {
                var t = ":" === e[0],
                    r = ":" === e[e.length - 1];
                a.push(' style="text-align:' + (t && r ? "center" : r ? "right" : "left") + '"')
            });
            for (var o = "th", c = s; n.length > c; ++c) {
                var l = r(n[c].trim());
                i += "<tr>";
                var u = 0;
                i += "<" + o + a[0] + ">" + l.rp(/\|/g, function() {
                    return ++u, "</" + o + "><" + o + a[u] + ">"
                }) + "</" + o + ">", i += "</tr>\n", c == s && (++c, o = "td")
            }
            return e("table", i)
    ...
    function d(e) {
        ...
        return e = e.rp(r, function(e, t) {
            ...
            for (t.split("\n").forEach(function(e) {
                ...
                if (o || a) {
                    if (s !== i.indentLevel)
                        if (-1 !== i.indentLevel && i.indentLevel > s)
                            for (; void 0 !== i && i.indentLevel > s;) n.pop(), r += "</li></" + i.tag + ">", i = n[n.length - 1];
                        else i = {
                            indentLevel: s,
                            tag: o ? "ol" : "ul",
                            indentChars: e.ss(0, s)
                        }, n.push(i), r += "<" + i.tag + ">";
                        else -1 !== i.indentLevel && (r += "</li>");
                    void 0 !== i && (r += "\n" + i.indentChars + "<li>" + t.rp(/^(\d+\.|-|\+|\*) /, ""))
                } else r += "\n" + i.indentChars + e
    ...
    function p(e) {
        var t = "",
            ...
            i = 0,
            s = 0;
        e = e.rp(/<h([1-6])>(.*)<\/h\1>/g, function(e, a, o) {
            a = parseInt(a), o = o.trim();
            for (var c = i; a > c; ++c) n[c] = 0;
            n.splice(a, i - a), i = a, ++n[i - 1];
            var l = n.join("."),
                u = "toc" + l;
            return 3 >= a && (t += Array(a).join("&nbsp;&nbsp;") + '<a href="#' + u + '">' + l + "&nbsp; " + o + "</a><br/>\n", 1 === a ? r += ' &middot; <a href="#' + u + '">' + o + "</a>" : ++s), '<a name="' + u + '"></a>' + e
        }), r.length > 0 && (r = r.ss(10));
        var a = n[0],
            o = a + s,
            c = "";
        4 > o && 1 >= a || 2048 > e.length || (c = 7 > a && 2.5 > o / a ? '<div class="shortTOC">' + r + "</div>" : '<div class="longTOC"><center><b>Contents</b></center><p>' + t + "</p></div>");
        var l = !1;
    ...
    function f(t, n) {
        function s(e) {
            var t = o(e);
            return t.h ? t.g + m(t.h, t.j) + s(t.m) : e
        }
        if (void 0 === n && (n = !0), void 0 !== t.innerHTML && (t = t.innerHTML), !n) {
            var a = /^\*\*([^ \t\*].*?[^ \t\*])\*\*[ \t]*\n/.source,
                f = /([ {4,}\t][ \t]*\S.*\n)*/.source;
            t = t.rp(RegExp(a + f, "g"), function(t, r) {
                r = r.trim();
        ...
        return t = s(t), [/\n~{3,}.*\n([\s\S]+?)\n~{3,}\n/gm, /\n`{3,}.*\n([\s\S]+?)\n`{3,}\n/gm].forEach(function(r) {
            ...
            return t = l(t, function(e) {
                return e.rp(/(`)(.+?)(`)/g, "<code>$2</code>")
        ...
        }), t = t.rp(/<protect>([\s\S]+?)<\/protect>/gm, "$1"), n || (t = p(t)), '<span class="md">' + e("p", t) + "</span>"
    }
    ...
    function m(e, t) {
        ...
        function x(e) {
            ...
            return t._used = [], t.width = e.indexOf("\n"), t.height = e.split("\n").length, "\n" === e[e.length - 1] && --t.height, t.o = function(e, r) {
                ...
                var n = t(e, r - 1),
                    ...
                    c = t(e + 1, r - 1),
                    l = t(e - 1, r - 1);
                return d(i) ? s(n) || "^" === n || d(n) || f(n) || a(o) || "v" === o || d(o) || f(o) || g(n) || g(o) || "_" === t(e, r - 1) || "_" === l || "_" === c || (s(l) || s(c)) && (a(t(e - 1, r + 1)) || a(t(e + 1, r + 1))) : s(i) || "^" === i ? d(o) || f(o) && "." !== i : a(i) || "v" === i ? d(n) || f(n) && "'" !== i : g(i) ? d(n) || d(o) : !1
            }, t.s = function(e, r) {
                void 0 === r && (r = e.x, e = e.x);
                var n = t(e - 2, r),
                    s = t(e - 1, r),
                    ...
                    u = t(e + 1, r),
                    d = t(e + 2, r);
                return l(a) || l(s) && f(a) ? l(s) ? l(u) || c(u) || l(n) || o(n) : o(s) ? l(u) : l(u) && (l(d) || c(d)) : "<" === a ? l(u) && l(d) : ">" === a ? l(s) && l(n) : i(a) ? l(s) && l(n) || l(u) && l(d) : !1
            }, t.u = function(e, r) {
                void 0 === r && (r = e.x, e = e.x);
                var n = t(e, r),
                    o = t(e - 1, r - 1),
                    c = t(e + 1, r + 1);
                return "\\" === n ? p(c) || a(c) || g(c) || "v" === c || p(o) || s(o) || g(o) || "^" === o || "/" === t(e, r - 1) || "/" === t(e, r + 1) || "_" === c || "_" === o : "." === n ? "\\" === c : "'" === n ? "\\" === o : "^" === n ? "\\" === c : "v" === n ? "\\" === o : i(n) || g(n) || "|" === n ? p(o) || p(c) : void 0
            }, t.F = function(e, r) {
                void 0 === r && (r = e.x, e = e.x);
                var n = t(e, r),
                    o = t(e - 1, r + 1),
                    c = t(e + 1, r - 1);
                return "/" !== n || "\\" !== t(e, r - 1) && "\\" !== t(e, r + 1) ? h(n) ? h(c) || s(c) || g(c) || "^" === c || "_" === c || h(o) || a(o) || g(o) || "v" === o || "_" === o : "." === n ? "/" === o : "'" === n ? "/" === c : "^" === n ? "/" === o : "v" === n ? "/" === c : i(n) || g(n) || "|" === n ? h(o) || h(c) : !1 : !0
            }, t.toString = function() {
                return e
            }, Object.freeze(t)
        }
        ...
        function $(e) {
            return function(t, r) {
                for (var n = 0; this.X.length > n; ++n)
                    if (e.call(this.X[n], t, r)) return !0;
                return !1
            }
        }
        ...
        function B(e, t) {
            for (var r = 0; e.width > r; ++r)
                for (var n = 0; e.height > n; ++n)
                    if (e.q(r, n)) {
                        var o = y(r, n);
                        do e.o(r, n), ++n; while (e.q(r, n));
                        var c = y(r, n - 1),
                            h = e(o),
                            p = e(o.x, o.y - 1);
                        (!i(h) && ("-" === p || "_" === p || "_" === e(o.x - 1, o.y - 1) || "_" === e(o.x + 1, o.y - 1) || a(p)) || f(p)) && (o.y -= .5);
                        var b = e(c),
                            m = e(c.x, c.y + 1);
                        (!i(b) && ("-" === m || s(m)) || f(m) || "_" === e(c.x - 1, c.y) || "_" === e(c.x + 1, c.y)) && (c.y += .5), (o.x !== c.x || o.y !== c.y) && t.Y(new C(o, c))
                    } else "'" === e(r, n) && ("-" === e(r - 1, n) && "_" === e(r + 1, n - 1) && !u(e(r - 1, n - 1)) || "_" === e(r - 1, n - 1) && "-" === e(r + 1, n) && !u(e(r + 1, n - 1))) ? t.Y(new C(y(r, n - .5), y(r, n))) : "." === e(r, n) && ("_" === e(r - 1, n) && "-" === e(r + 1, n) && !u(e(r + 1, n + 1)) || "-" === e(r - 1, n) && "_" === e(r + 1, n) && !u(e(r - 1, n + 1))) && t.Y(new C(y(r, n), y(r, n + .5)));
            for (var n = 0; e.height > n; ++n)
                for (var r = 0; e.width > r; ++r)
                    if (e.s(r, n)) {
                        var o = y(r, n);
                        do e.o(r, n), ++r; while (e.s(r, n));
                        var c = y(r - 1, n);
                        !i(e(o.x - 1, o.y)) && (s(e(o)) && u(e(o.x - 1, o.y + 1)) || a(e(o)) && u(e(o.x - 1, o.y - 1))) && ++o.x, !i(e(c.x + 1, c.y)) && (s(e(c)) && u(e(c.x + 1, c.y + 1)) || a(e(c)) && u(e(c.x + 1, c.y - 1))) && --c.x, (o.x !== c.x || o.y !== c.y) && t.Y(new C(o, c))
                    }
            for (var v = -e.height; e.width > v; ++v)
                for (var r = v, n = 0; e.height > n; ++n, ++r)
                    if (e.u(r, n)) {
                        var o = y(r, n);
                        do e.o(r, n), ++r, ++n; while (e.u(r, n));
                        var c = y(r - 1, n - 1);
                        ("/" === e(o.x, o.y - 1) || "_" === e(o.x - 1, o.y - 1) || "_" === e(o.x, o.y - 1)) && (o.x -= .5, o.y -= .5), ("/" === e(c.x, c.y + 1) || "_" === e(c.x + 1, c.y) || "_" === e(c.x - 1, c.y)) && (c.x += .5, c.y += .5), t.Y(new C(o, c))
                    }
            for (var v = -e.height; e.width > v; ++v)
                for (var r = v, n = e.height - 1; n >= 0; --n, ++r)
                    if (e.F(r, n)) {
                        var o = y(r, n);
                        do e.o(r, n), ++r, --n; while (e.F(r, n));
                        var c = y(r - 1, n + 1);
                        ("\\" === e(c.x, c.y - 1) || "_" === e(c.x, c.y - 1) || "_" === e(c.x + 1, c.y - 1)) && (c.x += .5, c.y -= .5), ("\\" === e(o.x, o.y + 1) || "_" === e(o.x - 1, o.y) || "_" === e(o.x + 1, o.y)) && (o.x -= .5, o.y += .5), t.Y(new C(o, c))
                    }
            for (var n = 0; e.height > n; ++n)
                for (var r = 0; e.width > r; ++r) {
                    var x = e(r, n);
                    s(x) && (l(e(r - 1, n)) && d(e(r + 1, n + 1)) && (e.o(r - 1, n), e.o(r, n), e.o(r + 1, n + 1), t.Y(new C(y(r - 1, n), y(r + 1, n + 1), y(r + 1.1, n), y(r + 1, n + 1)))), l(e(r + 1, n)) && d(e(r - 1, n + 1)) && (e.o(r - 1, n + 1), e.o(r, n), e.o(r + 1, n), t.Y(new C(y(r + 1, n), y(r - 1, n + 1), y(r - 1.1, n), y(r - 1, n + 1))))), ")" !== x && !g(x) || "." !== e(r - 1, n - 1) || "'" !== e(r - 1, n + 1) || (e.o(r, n), e.o(r - 1, n - 1), e.o(r - 1, n + 1), t.Y(new C(y(r - 2, n - 1), y(r - 2, n + 1), y(r + .6, n - 1), y(r + .6, n + 1)))), "(" !== x && !g(x) || "." !== e(r + 1, n - 1) || "'" !== e(r + 1, n + 1) || (e.o(r, n), e.o(r + 1, n - 1), e.o(r + 1, n + 1), t.Y(new C(y(r + 2, n - 1), y(r + 2, n + 1), y(r - .6, n - 1), y(r - .6, n + 1)))), a(x) && (l(e(r - 1, n)) && d(e(r + 1, n - 1)) && (e.o(r - 1, n), e.o(r, n), e.o(r + 1, n - 1), t.Y(new C(y(r - 1, n), y(r + 1, n - 1), y(r + 1.1, n), y(r + 1, n - 1)))), l(e(r + 1, n)) && d(e(r - 1, n - 1)) && (e.o(r - 1, n - 1), e.o(r, n), e.o(r + 1, n), t.Y(new C(y(r + 1, n), y(r - 1, n - 1), y(r - 1.1, n), y(r - 1, n - 1)))))
                }
            for (var n = 0; e.height > n; ++n)
                for (var r = 0; e.width - 2 > r; ++r)
                    if ("_" === e(r, n) && "_" === e(r + 1, n)) {
                        var o = y(r - .5, n + .5),
                            w = e(r - 1, n),
                            N = e(r - 2, n);
                        "|" === w || "|" === e(r - 1, n + 1) || "." === w || "'" === e(r - 1, n + 1) ? (o.x -= .5, "." !== w || "-" !== N && "." !== N || "(" !== e(r - 2, n + 1) || (o.x -= .5)) : "/" === w && (o.x -= 1), "(" === w && "(" === N && "'" === e(r, n + 1) && "." === e(r, n - 1) && (o.x += .5), w = N = void 0;
                        do e.o(r, n), ++r; while ("_" === e(r, n));
                        var c = y(r - .5, n + .5),
                            x = e(r, n),
                            _ = e(r + 1, n),
                            b = e(r, n + 1);
                        "|" === x || "|" === b || "." === x || "'" === b ? (c.x += .5, "." !== x || "-" !== _ && "." !== _ || ")" !== e(r + 1, n + 1) || (c.x += .5)) : "\\" === x && (c.x += 1), ")" === x && ")" === _ && "'" === e(r - 1, n + 1) && "." === e(r - 1, n - 1) && (c.x += -.5), t.Y(new C(o, c))
                    }
        }
        ...
        function E(e, t, r) {
            ...
            for (var a = 0; e.width > a; ++a)
                for (var o = 0; e.height > o; ++o) {
                    var c = e(a, o),
                        l = o;
                    if (f(c)) t.S(a, l - .5) && t.M(a, l + .5) && (r.Y(a, l, c), e.o(a, l));
                    else if (g(c)) {
                        var u = e(a, l - 1),
                            d = e(a, l + 1),
                            h = e(a - 1, l),
                            p = e(a + 1, l);
                        (t.U(a - 1, l) || t.T(a + 1, l) || t.S(a, l - 1) || t.M(a, l + 1) || s(u, d, h, p)) && (r.Y(a, l, c), e.o(a, l))
                    } else {
                        var b = 0;
                        ">" === c && (t.U(a, l) || t.W(a, l)) ? (g(e(a + 1, l)) && (b = -.5), r.Y(a + b, l, ">", 0), e.o(a, l)) : "<" === c && (t.T(a, l) || t.W(a, l)) ? (g(e(a - 1, l)) && (b = .5), r.Y(a + b, l, ">", 180), e.o(a, l)) : "^" === c ? t.M(a, l - .5) ? (r.Y(a, l - .5, ">", 270), e.o(a, l)) : t.M(a, l) ? (r.Y(a, l, ">", 270), e.o(a, l)) : t.N(a, l) ? (r.Y(a, l, ">", 270 + T), e.o(a, l)) : t.P(a, l) ? (r.Y(a, l, c, 270 - T), e.o(a, l)) : t.V(a, l) && (r.Y(a, l - .5, ">", 270), e.o(a, l)) : "v" === c && (t.S(a, l + .5) ? (r.Y(a, l + .5, ">", 90), e.o(a, l)) : t.S(a, l) ? (r.Y(a, l, ">", 90), e.o(a, l)) : t.O(a, l) ? (r.Y(a, l, ">", 90 + T), e.o(a, l)) : t.R(a, l) ? (r.Y(a, l, ">", 90 - T), e.o(a, l)) : t.V(a, l) && (r.Y(a, l + .5, ">", 90), e.o(a, l)))
                    }
                }
        }
        e = b(e);
        ...
        F.G = function() {
            ...
            return void 0 === t && (t = e.y, e = e.x), this.G() && this.A.x === e && L(this.A.y, this.B.y) === t
        }, F.N = function(e, t) {
            return this.I() ? (void 0 === t && (t = e.y, e = e.x), this.B.y > this.A.y ? this.A.x === e && this.A.y === t : this.B.x === e && this.B.y === t) : !1
        }, F.O = function(e, t) {
            return this.I() ? (void 0 === t && (t = e.y, e = e.x), this.A.y > this.B.y ? this.A.x === e && this.A.y === t : this.B.x === e && this.B.y === t) : !1
        }, F.P = function(e, t) {
            return this.J() ? (void 0 === t && (t = e.y, e = e.x), this.B.y > this.A.y ? this.A.x === e && this.A.y === t : this.B.x === e && this.B.y === t) : !1
        }, F.R = function(e, t) {
            return this.J() ? (void 0 === t && (t = e.y, e = e.x), this.A.y > this.B.y ? this.A.x === e && this.A.y === t : this.B.x === e && this.B.y === t) : !1
        }, F.S = function(e, t) {
            return void 0 === t && (t = e.y, e = e.x), this.G() && this.A.x === e && S(this.A.y, this.B.y) === t
        }, F.T = function(e, t) {
            return void 0 === t && (t = e.y, e = e.x), this.H() && this.A.y === t && L(this.A.x, this.B.x) === e
        }, F.U = function(e, t) {
            return void 0 === t && (t = e.y, e = e.x), this.H() && this.A.y === t && S(this.A.x, this.B.x) === e
        }, F.V = function(e, t) {
            return void 0 === t && (t = e.y, e = e.x), this.G() && this.A.x === e && L(this.A.y, this.B.y) <= t && S(this.A.y, this.B.y) >= t
        }, F.W = function(e, t) {
            return void 0 === t && (t = e.y, e = e.x), this.H() && this.A.y === t && L(this.A.x, this.B.x) <= e && S(this.A.x, this.B.x) >= e
        }, F.toSVG = function() {
            var e = '<path d="M ' + this.A;
            return e += this.K() ? "C " + this.C + this.D + this.B : "L " + this.B, e += '" style="fill:none;stroke:#000;"', e += "/>"
        };
        var Z = M.prototype;
        Z.Y = function(e) {
            this.X.push(e)
        }, Z.M = $(F.M), Z.N = $(F.N), Z.P = $(F.P), Z.O = $(F.O), Z.R = $(F.R), Z.S = $(F.S), Z.T = $(F.T), Z.U = $(F.U), Z.L = $(F.L), Z.V = $(F.V), Z.W = $(F.W), Z.toSVG = function() {
            for (var e = "", t = 0; this.X.length > t; ++t) e += this.X[t].toSVG() + "\n";
            return e
        };
        var K = j.prototype;
        K.Y = function(e, t, r, n) {
            void 0 === r && (r = t, t = e.y, e = e.x), n = n || 0, !m(r), this.Z.push({
                C: y(e, t),
                type: r,
                angle: n
            })
        }, K.toSVG = function() {
            for (var e = "", t = 0; this.Z.length > t; ++t) {
                var r = this.Z[t],
                    n = r.C;
                if (f(r.type)) {
                    var i = ")" === r.type ? .75 : -.75,
                        ...
                        o = y(n.x + i, n.y - .5),
                        c = y(n.x + i, n.y + .5);
                    e += '<path d="M ' + a + " C " + c + o + s + '" style="fill:none;stroke:#000;"/>'
                } else if (g(r.type)) e += '<circle cx="' + n.x * A + '" cy="' + n.y * A * R + '" r="' + (A - k) + '" style="fill:' + ("*" === r.type ? "black" : "white") + '; stroke:black;"/>';
                else {
                    var l = y(n.x + 1, n.y),
                        s = y(n.x - .5, n.y - .35),
                        a = y(n.x - .5, n.y + .35);
                    e += '<polygon points="' + l + s + a + '" style="fill:black" transform="rotate(' + r.angle + "," + n + ')"/>\n'
                }
            }
            return e
        };
        var Y = x(e),
            ...
            P = new j;
        B(Y, Q), E(Y, Q, P);
        var D = '<svg class="diagram" xmlns="http://www.w3.org/2000/svg" version="1.1" height="' + (Y.height + 1) * A * R + '" width="' + (Y.width + 1) * A + '"';
        if ("left" === t ? D += ' style="float:' + t + ';margin: 15px 30px 15px 0px;"' : "right" === t && (D += ' style="float:' + t + ';margin: 15px 0px 15px 30px;"'), D += '><g transform="translate(' + y(1, 1) + ')">\n', w) {
            D += '<g style="opacity:0.1">\n';
            for (var G = 0; Y.width > G; ++G)
                for (var V = 0; Y.height > V; ++V) D += '<rect x="' + ((G - .5) * A + 1) + '" + y="' + ((V - .5) * A * R + 2) + '" width="' + (A - 2) + '" height="' + (A * R - 2) + '" style="fill:', D += Y.p(G, V) ? "red;" : " " === Y(G, V) ? "gray; opacity:0.05" : "blue;", D += '"/>\n';
            D += "</g>\n"
        }
        if (D += Q.toSVG(), D += P.toSVG(), !_) {
            D += '<g transform="translate(0,0)">';
            for (var G = 0; Y.width > G; ++G)
                for (var V = 0; Y.height > V; ++V) {
                    var X = Y(G, V);
                    " " === X || Y.p(G, V) || (D += '<text text-anchor="middle" x="' + G * A + '" y="' + (4 + V * A * R) + '" style="fill:#000;">' + r(X) + "</text>")
                }
            D += "</g>"
        }
        if (N) {
            D += '<g transform="translate(2, 2)">\n';
            for (var G = 0; Y.width > G; ++G)
                for (var V = 0; Y.height > V; ++V) {
                    var X = Y(G, V);
                    " " !== X && (D += '<text text-anchor="middle" x="' + G * A + '" y="' + (4 + V * A * R) + '" style="fill:#F00;font-family:Menlo,monospace;font-size:12px;text-align:center">' + r(X) + "</text>")
                }
            D += "</g>"
        }
        return D += "</g></svg>"
    ...
    var w = !1,
        ...
        C = "*",
        M = Array(6).join(C),
        $ = e("style", 'body { max-width: 680px;margin: auto;padding: 20px;text-align: justify;line-height: 139%; color: #222;font-family: Palatino,Georgia,"Times New Roman",serif;}'),
        ...
        B = '<!-- Markdeep: --><style class="fallback">body{white-space:pre;font-family:monospace}</style><script src="markdeep.min.js"></script><script src="http://casual-effects.com/markdeep/latest/markdeep.min.js"></script>',
    ...
    if (!window.alreadyProcessedMarkdeep) {
        ...
        switch (T) {
            ...
            case "doxygen":
                return y(document.getElementsByClassName("diagram")).concat(y(document.getElementsByTagName("diagram"))).forEach(function(e) {
                    var t = n(e.innerHTML);
                    t = t.rp(/(:?^[ \t]*\n)|(:?\n[ \t]*)$/g, ""), "doxygen" === T && (t = t.rp(RegExp("â€“", "g"), "--"), t = t.rp(RegExp("â€”", "g"), "---"), t = t.rp(/<a class="el" .*>(.*)<\/a>/g, "$1")), e.outerHTML = '<center class="md">' + m(g(t), "") + "</center>"
        ...
        z || y(document.getElementsByTagName("script")).forEach(function(e) {
            v(e.src) && e.parentNode.removeChild(e)
        });
        var I = a(document.body);
        if (z) return I = I.rp(/<!-- Markdeep:.+(-->|<script.+?<\/script>)/g, "") + B, I = I.rp(/</g, "&lt;").rp(/>/g, "&gt;"), void(document.body.innerHTML = e("pre", I));
        I = n(I), setTimeout(function() {
            ...
            var a = I.length > 1e3,
                o = $ + j + s() + R;
            if (a && (o += e("style", "div.title { padding-top: 20px; } div.afterTitles { height: 15px; }")), document.head.innerHTML = '<meta charset="UTF-8"><meta http-equiv="content-type" content="text/html; charset=UTF-8">' + o + document.head.innerHTML, document.body.innerHTML = r, n) {
                var c = document.createElement("script");
                c.type = "text/javascript", c.src = "http://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML", document.getElementsByTagName("head")[0].appendChild(c)
            }
        }, 0)
    }
}(), ! function(e) {
    ...
    function s(e) {
        ...
        if (s += e.parentNode ? e.parentNode.className : "", r = /\blang(?:uage)?-([\w-]+)\b/i.exec(s)) return x(r[1]) ? r[1] : "no-highlight";
        for (s = s.split(/\s+/), t = 0, n = s.length; n > t; t++)
            if (x(s[t]) || i(s[t])) return s[t]
    }
    ...
    function o(e) {
        ...
        return function n(e, i) {
            for (var s = e.firstChild; s; s = s.nextSibling) 3 == s.nodeType ? i += s.nodeValue.length : 1 == s.nodeType && (t.push({
                event: "start",
                offset: i,
                node: s
            }), i = n(s, i), r(s).match(/br|hr|img|input/) || t.push({
                event: "stop",
                offset: i,
                node: s
            }));
    ...
    function c(e, n, i) {
        ...
        for (var l = 0, u = "", d = []; e.length || n.length;) {
            var h = s();
            if (u += t(i.substr(l, h[0].offset - l)), l = h[0].offset, h == e) {
                d.reverse().forEach(o);
                do c(h.splice(0, 1)[0]), h = s(); while (h == e && h.length && h[0].offset == l);
                d.reverse().forEach(a)
            } else "start" == h[0].event ? d.push(h[0].node) : d.pop(), c(h.splice(0, 1)[0])
        }
    ...
    function l(e) {
        ...
        function n(i, s) {
            if (!i.compiled) {
                ...
                i.lR = r(i.l || /\b\w+\b/, !0), s && (i.bK && (i.b = "\\b(" + i.bK.split(" ").join("|") + ")\\b"), i.b || (i.b = /\B|\b/), i.bR = r(i.b), i.e || i.eW || (i.e = /\B|\b/), i.e && (i.eR = r(i.e)), i.tE = t(i.e) || "", i.eW && s.tE && (i.tE += (i.e ? "|" : "") + s.tE)), i.i && (i.iR = r(i.i)), void 0 === i.r && (i.r = 1), i.c || (i.c = []);
                var l = [];
    ...
    function u(e, r, i, s) {
        ...
        function f() {
            ...
            var e = "",
                r = 0;
            k.lR.lastIndex = 0;
            for (var n = k.lR.exec($); n;) {
                e += t($.substr(r, n.index - r));
                var i = h(k, n);
                i ? (j += i[1], e += p(i[0], t(n[0]))) : e += t(n[0]), r = k.lR.lastIndex, n = k.lR.exec($)
            }
            return e + t($.substr(r))
        }
        ...
        function b() {
            ...
            if (e && !N[k.sL]) return t($);
            var r = e ? u(k.sL, $, !0, C[k.sL]) : d($, k.sL.length ? k.sL : void 0);
            return k.r > 0 && (j += r.r), e && (C[k.sL] = r.top), p(r.language, r.value, !1, !0)
        }
        ...
        function m(e, r) {
            var n = e.cN ? p(e.cN, "", !0) : "";
            e.rB ? (M += n, $ = "") : e.eB ? (M += t(r) + n, $ = "") : (M += n, $ = r), k = Object.create(e, {
                parent: {
                    value: k
                }
            })
        ...
        function v(e, r) {
            if ($ += e, void 0 === r) return M += g(), 0;
            var n = a(r, k);
            if (n) return M += g(), m(n, r), n.rB ? 0 : r.length;
            var i = o(k, r);
            if (i) {
                var s = k;
                s.rE || s.eE || ($ += r), M += g();
                do k.cN && (M += "</span>"), j += k.r, k = k.parent; while (k != i.parent);
                return s.eE && (M += t(r)), $ = "", i.starts && m(i.starts, ""), s.rE ? 0 : r.length
            }
        ...
        var _, k = s || y,
            C = {}, M = "";
        for (_ = k; _ != y; _ = _.parent) _.cN && (M = p(_.cN, "", !0) + M);
        var $ = "",
            j = 0;
        try {
            for (var B, E, A = 0; k.t.lastIndex = A, B = k.t.exec(r), B;) E = v(r.substr(A, B.index - A), B[0]), A = B.index + E;
            for (v(r.substr(A)), _ = k; _.parent; _ = _.parent) _.cN && (M += "</span>");
            return {
                r: j,
                value: M,
                language: e,
    ...
    function f(e) {
        ...
        if (!i(t)) {
            ...
            if (l.length) {
                ...
                f.innerHTML = a.value, a.value = c(l, o(f), n)
            }
    ...
    return e.highlight = u, e.highlightAuto = d, e.fixMarkup = h, e.highlightBlock = f, e.configure = b, e.initHighlighting = g, e.initHighlightingOnLoad = m, e.$ = v, e._ = y, e.aa = x, e.inherit = a, e.IR = "[a-zA-Z]\\w*", e.UIR = "[a-zA-Z_]\\w*", e.NR = "\\b\\d+(\\.\\d+)?", e.CNR = "(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", e.BNR = "\\b(0b[01]+)", e.RSR = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",
    e.BE = {
        b: "\\\\[\\s\\S]",
        r: 0
    }, e.ASM = {
        ...
        return r.splice(r.length, 0, i, s), {
            c: r,
            k: t,
            i: "\\S"
        }
    }), e.$("makefile", function(e) {
        var t = {
            cN: "variable",
            b: /\$\(/,
            e: /\)/,
