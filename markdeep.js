...
! function() {
    ...
    function t(e) {
        return window.markdeepOptions && void 0 !== window.markdeepOptions[e] ? window.markdeepOptions[e] : void 0 !== L[e] ? L[e] : void 0
    }
    ...
    function c(e) {
        ...
        for (var r = {
            ...
            var i, a = T(0, e.lastIndexOf("\n", n)) + 1,
                s = n - a;
            for (i = n + E.length; e[i] === j; ++i);
            var o = i - a - 1,
                c = {
                    g: e.ss(0, a),
                    h: "",
            ...
            for (var p = !0, h = i; p;) {
                ...
                if (u ? c.j = "floatright" : d && (c.j = "floatleft"), e[a + s] === j && e[a + o] === j) {
                    for (var f = s; o > f && e[a + f] === j; ++f);
                    var b = a + s,
                        g = a + o;
                ...
                if (a > 14 && 16 > a / n.length) {
                    ...
                    for (var N = function(e, t) {
                        ...
                        for (b += "<table " + r('class="calendar"') + ">\n" + e("tr", e("th", h[x.getMonth()] + " " + x.getFullYear(), r('colspan="14"'))) + "<tr>", d.forEach(function(t) {
                                b += e("td", t, g)
                            }), b += "</tr>"; 0 !== new Date(x.getTime() + 432e5).getDay();) x = new Date(x.getTime() - i);
                        if (1 !== x.getDate())
    ...
    function f(e) {
        ...
        e = e.rp(/<h([1-6])>(.*?)<\/h\1>/gi, function(e, c, l) {
            ...
            var d = n.join("."),
                p = "toc" + d;
            return o[i(l).trim().toLowerCase()] = d, 3 >= c && (t += Array(c).join("&nbsp;&nbsp;") + '<a href="#' + p + '" class="level' + c + '">' + d + "&nbsp; " + l + "</a><br/>\n", 1 === c ? r += ' &middot; <a href="#' + p + '">' + l + "</a>" : ++s), '<a name="' + p + '"></a>' + e
        }), r.length > 0 && (r = r.ss(10));
        var c = n[0],
            l = c + s,
            u = e.indexOf("<h1>"),
            d = e.indexOf("<H1>"); - 1 !== d && (-1 === u || u > d) && (u = d), -1 === u && (u = 0);
        var p = '<div class="afterTitles"></div>',
            h = e.indexOf(p); - 1 === h ? h = 0 : h += p.length;
        var f = "";
        return 4 > l && 1 >= c || 2048 > e.length || (7 > c && 2.5 > l / c ? f = '<div class="shortTOC">' + r + "</div>" : -1 === u || u / 55 > l ? f = '<div class="mediumTOC"><center><b>Contents</b></center><p>' + t + "</p></div>" : (h = u, f = '<div class="longTOC"><div class="tocHeader">Contents</div><p>' + t + "</p></div>")), e = e.ss(0, h) + f + e.ss(h), [e, o]
    }
    ...
    function m(t, n) {
        function s(e) {
            for (var t = (M.push(e) - 1).toString($); j > t.length;) t = "0" + t;
            return C + t
        }

        function o(e) {
            var e = parseInt(e.ss(1), $);
            return M[e]
        }
        ...
        t = t.rp(/\n((?:_[ \t]*){3,}|(?:-[ \t]*){3,}|(?:\*[ \t]*){3,})\s*?\n/g, "\n<hr/>\n");
        var q = s('class="fancyquote"');
        t = t.rp(/\n>[ \t]*"(.*(?:\n>.*)*)"[ \t]*(?:\n>[ \t]*)?(\n>[ \t]{2,}\S.*)?\n/g, function(t, r, n) {
            return e("blockquote", e("span", r.rp(/\n>/g, "\n") + "&rdquo;", q) + (n ? e("span", n.rp(/\n>/g, "\n"), s('class="author"')) : ""), q)
        }), t = t.rp(/(?:\n>.*){2,}/g, function(t) {
            return e("blockquote", t.rp(/\n>/g, "\n"))
        }), t = t.rp(/\s*\[\^(.*?)\](?!:)/g, function(e, t) {
            return t = t.toLowerCase().trim(), t in N || (++_, N[t] = _), "<sup><a " + s('href="#endnote-' + t + '"') + ">" + N[t] + "</a></sup>"
            ...
            return k[t.toLowerCase().trim()] = r.trim(), ""
        ...
        t = t.rp(/(^|[^!])\[([^\[\]]+?)\]\(([^\)]+?)\)/g, function(e, t, r, n) {
            ...
            var s = S(t, n, i);
            return g(r, a) && (s = e("center", s)), r + s + a
        });
        for (var L = !0; L;) L = !1, t = t.rp(/(\s*)!\[([\s\S]+?)?\]\(([^\)\s]+?)([ \t].*?)?\)(\s*)/, function(t, r, n, i, a, o) {
            L = !0;
            var c = "";
            a && (a = a.rp(/width\s*:\s*\S+?[^;]/g, function(e) {
                return c = "width:" + e + ";", "width:100%"
            }), a = a.rp(/width\s*=\s*('\S+?'|"\S+?")/g, function(e, t) {
                return c = "width:" + t.ss(1, t.length - 1) + ";", 'style="width:100%" '
            }));
            var l = S(t, i, a);
            return g(r, o) ? (r += "<center>", o = "</center>" + o) : c += "float:right;margin:4px 0px 0px 25px;", r + e("div", l + e("div", n, s('class="imagecaption"')), s('class="image" style="' + c + '"')) + o
        });
    ...
    function x(e, t) {
        ...
        function w(e) {
            ...
            return t._used = [], t.width = e.indexOf("\n"), t.height = e.split("\n").length, "\n" === e[e.length - 1] && --t.height, t.q = function(e, r) {
                ...
                var n = t(e, r - 1),
                    ...
                    c = t(e + 1, r - 1),
                    l = t(e - 1, r - 1);
                return h(i) ? a(n) || "^" === n || h(n) || g(n) || s(o) || "v" === o || h(o) || g(o) || m(n) || m(o) || "_" === t(e, r - 1) || "_" === l || "_" === c || (a(l) || a(c)) && (s(t(e - 1, r + 1)) || s(t(e + 1, r + 1))) : a(i) || "^" === i ? h(o) || g(o) && "." !== i : s(i) || "v" === i ? h(n) || g(n) && "'" !== i : m(i) ? h(n) || h(o) : !1
            }, t.F = function(e, r) {
                void 0 === r && (r = e.x, e = e.x);
                var n = t(e - 2, r),
                    a = t(e - 1, r),
                ...
                var n = t(e, r),
                    o = t(e - 1, r - 1),
                    c = t(e + 1, r + 1);
                return "\\" === n ? b(c) || s(c) || m(c) || "v" === c || b(o) || a(o) || m(o) || "^" === o || "/" === t(e, r - 1) || "/" === t(e, r + 1) || "_" === c || "_" === o : "." === n ? "\\" === c : "'" === n ? "\\" === o : "^" === n ? "\\" === c : "v" === n ? "\\" === o : i(n) || m(n) || "|" === n ? b(o) || b(c) : void 0
            }, t.H = function(e, r) {
                void 0 === r && (r = e.x, e = e.x);
                var n = t(e, r),
                    o = t(e - 1, r + 1),
            ...
            for (var n = 0; e.width > n; ++n)
                for (var o = 0; e.height > o; ++o)
                    if (e.u(n, o)) {
                        ...
                        var b = e(l),
                            v = e(l.x, l.y + 1);
                        (!i(b) && ("-" === v || a(v)) || g(v) || "_" === e(l.x - 1, l.y) || "_" === e(l.x + 1, l.y)) && (l.y += .5), (c.x !== l.x || c.y !== l.y) && t.$(new N(c, l))
                    ...
                    if (e.G(n, o)) {
                        ...
                        if (r(c, l, "\\")) {
                            var w = e(c),
                                u = e(c.x, c.y - 1),
                                _ = e(c.x - 1, c.y - 1);
                            "/" === u || "_" === _ || "_" === u || !i(w) && (d(_) || h(_)) ? (c.x -= .5, c.y -= .5) : m(_) && (c.x -= .25, c.y -= .25);
                            var k = (e(l), e(l.x + 1, l.y + 1));
                            "/" === e(l.x, l.y + 1) || "_" === e(l.x + 1, l.y) || "_" === e(l.x - 1, l.y) || !i(e(l)) && (d(k) || h(k)) ? (l.x += .5, l.y += .5) : m(k) && (l.x += .25, l.y += .25), t.$(new N(c, l))
                        }
                    }
            for (var y = -e.height; e.width > y; ++y)
                    ...
                    if (e.H(n, o)) {
                        ...
                        if (r(c, l, "/")) {
                            var u = e(l.x, l.y - 1),
                                C = e(l.x + 1, l.y - 1);
                            e(l);
                            "\\" === u || "_" === u || "_" === C || !i(e(l)) && (d(C) || h(C)) ? (l.x += .5, l.y -= .5) : m(C) && (l.x += .25, l.y -= .25);
                            var $ = e(c.x - 1, c.y + 1),
                                w = e(c);
                            "\\" === e(c.x, c.y + 1) || "_" === e(c.x - 1, c.y) || "_" === e(c.x + 1, c.y) || !i(e(c)) && (d($) || h($)) ? (c.x -= .5, c.y += .5) : m($) && (c.x -= .25, c.y += .25), t.$(new N(c, l))
                        }
                    }
            for (var o = 0; e.height > o; ++o)
                for (var n = 0; e.width > n; ++n) {
                    var M = e(n, o);
                    a(M) && (d(e(n - 1, o)) && h(e(n + 1, o + 1)) && (e.q(n - 1, o), e.q(n, o), e.q(n + 1, o + 1), t.$(new N(x(n - 1, o), x(n + 1, o + 1), x(n + 1.1, o), x(n + 1, o + 1)))), d(e(n + 1, o)) && h(e(n - 1, o + 1)) && (e.q(n - 1, o + 1), e.q(n, o), e.q(n + 1, o), t.$(new N(x(n + 1, o), x(n - 1, o + 1), x(n - 1.1, o), x(n - 1, o + 1))))), ")" !== M && !m(M) || "." !== e(n - 1, o - 1) || "'" !== e(n - 1, o + 1) || (e.q(n, o), e.q(n - 1, o - 1), e.q(n - 1, o + 1), t.$(new N(x(n - 2, o - 1), x(n - 2, o + 1), x(n + .6, o - 1), x(n + .6, o + 1)))), "(" !== M && !m(M) || "." !== e(n + 1, o - 1) || "'" !== e(n + 1, o + 1) || (e.q(n, o), e.q(n + 1, o - 1), e.q(n + 1, o + 1), t.$(new N(x(n + 2, o - 1), x(n + 2, o + 1), x(n - .6, o - 1), x(n - .6, o + 1)))), s(M) && (d(e(n - 1, o)) && h(e(n + 1, o - 1)) && (e.q(n - 1, o), e.q(n, o), e.q(n + 1, o - 1), t.$(new N(x(n - 1, o), x(n + 1, o - 1), x(n + 1.1, o), x(n + 1, o - 1)))), d(e(n + 1, o)) && h(e(n - 1, o - 1)) && (e.q(n - 1, o - 1), e.q(n, o), e.q(n + 1, o), t.$(new N(x(n + 1, o), x(n - 1, o - 1), x(n - 1.1, o), x(n - 1, o - 1)))))
                }
            for (var o = 0; e.height > o; ++o)
            ...
            for (var a = 0; e.width > a; ++a)
                for (var s = 0; e.height > s; ++s) {
                    ...
                    if (g(o)) t.U(a, c - .5) && t.O(a, c + .5) && (r.$(a, c, o), e.q(a, c));
                        ...
                        var b = 0;
                        ">" === o && (t.W(a, c) || t.Y(a, c)) ? (m(e(a + 1, c)) && (b = -.5), r.$(a + b, c, ">", 0), e.q(a, c)) : "<" === o && (t.V(a, c) || t.Y(a, c)) ? (m(e(a - 1, c)) && (b = .5), r.$(a + b, c, ">", 180), e.q(a, c)) : "^" === o ? t.O(a, c - .5) ? (r.$(a, c - .5, ">", 270), e.q(a, c)) : t.O(a, c) ? (r.$(a, c, ">", 270), e.q(a, c)) : t.P(a + .5, c - .5) ? (r.$(a + .5, c - .5, ">", 270 + I), e.q(a, c)) : t.P(a + .25, c - .25) ? (r.$(a + .25, c - .25, ">", 270 + I), e.q(a, c)) : t.P(a, c) ? (r.$(a, c, ">", 270 + I), e.q(a, c)) : t.S(a, c) ? (r.$(a, c, o, 270 - I), e.q(a, c)) : t.S(a - .5, c - .5) ? (r.$(a - .5, c - .5, o, 270 - I), e.q(a, c)) : t.S(a - .25, c - .25) ? (r.$(a - .25, c - .25, o, 270 - I), e.q(a, c)) : t.X(a, c) && (r.$(a, c - .5, ">", 270), e.q(a, c)) : "v" === o && (t.U(a, c + .5) ? (r.$(a, c + .5, ">", 90), e.q(a, c)) : t.U(a, c) ? (r.$(a, c, ">", 90), e.q(a, c)) : t.R(a, c) ? (r.$(a, c, ">", 90 + I), e.q(a, c)) : t.R(a - .5, c + .5) ? (r.$(a - .5, c + .5, ">", 90 + I), e.q(a, c)) : t.R(a - .25, c + .25) ? (r.$(a - .25, c + .25, ">", 90 + I), e.q(a, c)) : t.T(a, c) ? (r.$(a, c, ">", 90 - I), e.q(a, c)) : t.T(a + .5, c + .5) ? (r.$(a + .5, c + .5, ">", 90 - I), e.q(a, c)) : t.T(a + .25, c + .25) ? (r.$(a + .25, c + .25, ">", 90 - I), e.q(a, c)) : t.X(a, c) && (r.$(a, c + .5, ">", 90), e.q(a, c)))
                    }
                }
        }
        e = v(e);
        ...
        Q.I = function() {
            ...
            return void 0 === t && (t = e.y, e = e.x), this.I() && this.A.x === e && T(this.A.y, this.B.y) === t
        }, Q.V = function(e, t) {
            return void 0 === t && (t = e.y, e = e.x), this.J() && this.A.y === t && R(this.A.x, this.B.x) === e
        }, Q.W = function(e, t) {
            return void 0 === t && (t = e.y, e = e.x), this.J() && this.A.y === t && T(this.A.x, this.B.x) === e
        }, Q.X = function(e, t) {
            return void 0 === t && (t = e.y, e = e.x), this.I() && this.A.x === e && R(this.A.y, this.B.y) <= t && T(this.A.y, this.B.y) >= t
        }, Q.Y = function(e, t) {
            return void 0 === t && (t = e.y, e = e.x), this.J() && this.A.y === t && R(this.A.x, this.B.x) <= e && T(this.A.x, this.B.x) >= e
        }, Q.toSVG = function() {
        ...
        G.$ = function(e) {
            this.Z.push(e)
        }, G.O = j(Q.O), G.P = j(Q.P), G.S = j(Q.S), G.R = j(Q.R), G.T = j(Q.T), G.U = j(Q.U), G.V = j(Q.V), G.W = j(Q.W), G.N = j(Q.N), G.X = j(Q.X), G.Y = j(Q.Y), G.toSVG = function() {
        ...
        V.$ = function(e, t, r, n) {
            ...
            m(r) ? this._.push(i) : this._.unshift(i)
        }, V.toSVG = function() {
            for (var e = "", t = 0; this._.length > t; ++t) {
                ...
                } else if (m(r.type)) e += '<circle cx="' + n.x * S + '" cy="' + n.y * S * L + '" r="' + (S - M) + '" style="fill:' + ("*" === r.type ? "#000" : "#FFF") + ';stroke:#000;"/>';
                else if (l(r.type)) {
                    var d = Math.round(63.75 * (3 - Z.indexOf(r.type)));
                    e += '<rect x="' + (n.x - .5) * S + '" y="' + (n.y - .5) * S * L + '" width="' + S + '" height="' + S * L + '" fill="rgb(' + d + "," + d + "," + d + ')"/>'
                } else if (u(r.type)) {
        ...
        var Y = w(e),
            ...
            X = new E;
        B(Y, J), A(Y, J, X);
        var ee = '<svg class="diagram" xmlns="http://www.w3.org/2000/svg" version="1.1" height="' + (Y.height + 1) * S * L + '" width="' + (Y.width + 1) * S + '"';
        if ("floatleft" === t ? ee += ' style="float:left;margin: 15px 30px 15px 0px;"' : "floatright" === t ? ee += ' style="float:right;margin: 15px 0px 15px 30px;"' : "center" === t && (ee += ' style="margin: 0px auto 0px auto;"'), ee += '><g transform="translate(' + x(1, 1) + ')">\n', k) {
            ...
            for (var te = 0; Y.width > te; ++te)
                for (var re = 0; Y.height > re; ++re) ee += '<rect x="' + ((te - .5) * S + 1) + '" + y="' + ((re - .5) * S * L + 2) + '" width="' + (S - 2) + '" height="' + (S * L - 2) + '" style="fill:', ee += Y.s(te, re) ? "red;" : " " === Y(te, re) ? "gray; opacity:0.05" : "blue;", ee += '"/>\n';
            ee += "</g>\n"
        }
        if (ee += J.toSVG(), ee += X.toSVG(), !$) {
            ee += '<g transform="translate(0,0)">';
            for (var re = 0; Y.height > re; ++re)
                for (var te = 0; Y.width > te; ++te) {
                    var ne = Y(te, re);
                    /[\u2B22\u2B21]/.test(ne) ? ee += '<text text-anchor="middle" x="' + te * S + '" y="' + (4 + re * S * L) + '" style="fill:#000;font-size:20.5px">' + r(ne) + "</text>" : " " === ne || Y.s(te, re) || (ee += '<text text-anchor="middle" x="' + te * S + '" y="' + (4 + re * S * L) + '" style="fill:#000">' + r(ne) + "</text>")
                }
            ee += "</g>"
        }
        if (C) {
            ...
            for (var te = 0; Y.width > te; ++te)
                for (var re = 0; Y.height > re; ++re) {
                    var ne = Y(te, re);
                    " " !== ne && (ee += '<text text-anchor="middle" x="' + te * S + '" y="' + (4 + re * S * L) + '" style="fill:#F00;font-family:Menlo,monospace;font-size:12px;text-align:center">' + r(ne) + "</text>")
                }
            ee += "</g>"
        }
    ...
    _.rp = _.replace, _.ss = _.substring;
    var k = !1,
        C = k,
        $ = C,
        M = 2,
        ...
        S = '<div class="markdeepFooter"><i>formatted by <a href="http://casual-effects.com/markdeep" style="color:#999">Markdeep&nbsp;&nbsp;&nbsp;</a></i><div style="display:inline-block;font-size:13px;font-family:\'Times New Roman\',serif;vertical-align:middle;transform:translate(-3px,-1px)rotate(135deg);">&#x2712;</div></div>',
        L = {
            mode: "markdeep",
            detectMath: !0
        },
    ...
    if (!window.alreadyProcessedMarkdeep) {
        ...
        if (O) return D = D.rp(/<!-- Markdeep:.+$/gm, "") + q, D = D.rp(/</g, "&lt;").rp(/>/g, "&gt;"), void(document.body.innerHTML = e("pre", D));
